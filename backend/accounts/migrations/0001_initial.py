    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_verified', models.BooleanField(default=False)),
                ('identity_type', models.CharField(choices=[('bvn', 'BVN'), ('nin', 'NIN'), ('national_passport', 'National Passport')], max_length=50, verbose_name='Identity Type')),
                ...
                ('stakeholder_photo', models.ImageField(max_length=255, upload_to=accounts.models.upload_stakeholder_image, verbose_name='Stakeholder Photo')),
